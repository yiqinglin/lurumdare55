...
public static class CatLookup
{
    private static readonly Dictionary<HashSet<Ingredient>, Cat[]> foodToCatMap = new Dictionary<HashSet<Ingredient>, Cat[]>(HashSet<Ingredient>.CreateSetComparer())
    {
        ...
        { new HashSet<Ingredient>{Ingredient.DriedFish}, new Cat[] { Cat.Ginger } },
        ...
        { new HashSet<Ingredient>{ Ingredient.CannedFood, Ingredient.DriedFish }, new Cat[] { Cat.Siamese, Cat.Ginger } },
        { new HashSet<Ingredient>{ Ingredient.CannedFood, Ingredient.Slime }, new Cat[] { Cat.Ginger } },
